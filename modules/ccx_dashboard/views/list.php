...
?>
<?php init_head(); ?>
<div id="wrapper" class="ccx-dashboard-widget-list">
  <div class="content">
    <div class="row">
      <div class="col-md-12">
        <form method="get" action="<?php echo admin_url('ccx_dashboard/widgets'); ?>">
          <div class="ccxdashboard-actions-wrap ccxdashboard-actions-wrap-between">
            <div class="ccxdashboard-actions-section-left">
              <?php if (has_permission('ccx_dashboard', '', 'widget_create')) { ?>
            ...
            <div class="ccxdashboard-actions-section-right">
              <select name="category" class="form-control ccxdashboard-categories-select">
              ...
              <input type="text" name="search" class="form-control ccxdashboard-search-input" placeholder="<?= _l('search_input_placeholder') ?>" value="<?php echo $active_search; ?>" />
              <div>
    ...
    <div class="row">
      <?php if (count($widgets) > 0) { ?>
        <div class="col-md-12 mtop30">
          <div class="row">
            <?php ccx_dashboard_render_widgets($widgets); ?>
          </div>
        </div>
      <?php } else { ?>
        <div class="col-md-12 mtop30">
...
<!-- create widget -->
<form action="<?= admin_url('ccx_dashboard/widgets/store_widget')  ?>" method="post" class="form-horizontal">
            ...
            <div class="col-md-6">
              <div class="input-group">
                ...
                <div class="input-group-addon">
                  <span><a href="<?php echo admin_url('ccx_dashboard/categories'); ?>" tabindex="-1"><i class="fa fa-plus"></i></a></span>
                </div>
              </div>
            </div>
          </div>
...
<!-- edit widget -->
<form action="<?= admin_url('ccx_dashboard/widgets/update_widget')  ?>" method="post" class="form-horizontal">
...
<!-- form delete widget -->
<form id="formDeleteWidget" action="<?php echo base_url('admin/ccx_dashboard/widgets/destroy_widget'); ?>" method="post" class="d-none">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
  <input type="hidden" name="id" value="" />
</form>
<script>
  ...
  <?php } ?>
  <?php if (has_permission('ccx_dashboard', '', 'widget_delete')) { ?>
