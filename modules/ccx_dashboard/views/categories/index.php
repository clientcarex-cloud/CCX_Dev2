    ...
    <div class="panel_s">
      <div class="panel-body">
        ...
        <div class="ccxdashboard-button-wrap">
          <?php if(has_permission('ccx_dashboard','','widget_category_create')){ ?>
            ...
            <?php if(count($categories) > 0) { ?>
              <?php foreach($categories as $category) { ?>
                <tr>
                  ...
                  <td>
                    <?php if(has_permission('ccx_dashboard','','widget_category_edit')){ ?>
                      <a href="javascript:void(0);" class="btn btn-primary btn-xs btn-edit-category" data-id="<?= $category['id'] ?>"><?php echo _l('edit'); ?></a>
                    <?php } ?>
                    <?php if(has_permission('ccx_dashboard','','widget_category_delete')){ ?>
...
<!-- form create -->
<form action="<?php echo base_url('admin/ccx_dashboard/categories/store_category'); ?>" method="post" class="form-horizontal">
...
<!-- form edit -->
<form action="<?php echo base_url('admin/ccx_dashboard/categories/update_category'); ?>" method="post" class="form-horizontal">
...
<!-- form delete -->
<form id="formDelete" action="<?php echo base_url('admin/ccx_dashboard/categories/destroy_category'); ?>" method="post" class="d-none">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
  <input type="hidden" name="id" value="" />
</form>
<script>
