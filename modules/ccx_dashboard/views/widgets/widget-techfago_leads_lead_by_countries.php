      ...
      <div class="row">
        <div class="col-md-12">
          <div class="relative max-height-400">
            <canvas id="ccx_dashboard_widget_<?= $widget['id'] ?>_chart_data" class="animated fadeIn" height="400"></canvas>
          </div>
        </div>
      </div>
    </div>
...
<script>
  window['ccx_dashboard_widget_<?= $widget['id'] ?>_chart_data'] = <?= json_encode($widget_data); ?>;
</script>