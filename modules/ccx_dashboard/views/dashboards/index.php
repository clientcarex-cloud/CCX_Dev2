  ...
  <div class="content">
    <div class="panel_s">
      <div class="panel-body">
        ...
        <div class="ccxdashboard-button-wrap">
          <?php if (has_permission('ccx_dashboard', '', 'dashboard_create')) { ?>
          ...
          <tbody>
            <?php if (count($dashboards) > 0) { ?>
              <?php foreach ($dashboards as $dashboard) { ?>
                <?php $link_builder = admin_url('ccx_dashboard/dashboards/edit_dashboard?dashboard_id=' . $dashboard['id']); ?>
                <tr>
                  ...
                  <td>
                    ...
                    <?php } ?>
                    <?php if (has_permission('ccx_dashboard', '', 'dashboard_clone')) { ?>
        ...
        <!-- form create -->
        <form action="<?php echo base_url('admin/ccx_dashboard/dashboards/store_dashboard'); ?>" method="post" class="form-horizontal">
        ...
        <!-- form clone -->
        <form action="<?php echo base_url('admin/ccx_dashboard/dashboards/clone_dashboard'); ?>" method="post" class="form-horizontal">
