...
<?php init_head(); ?>
<div id="wrapper">
    <div class="content ccx-dashboard-widget-list">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="get" action="<?php echo admin_url('ccx_dashboard/dashboards/my_dashboard'); ?>">
                    <div class="ccxdashboard-actions-wrap ccxdashboard-actions-wrap-between">
                        <div class="ccxdashboard-actions-section-left">
                            <select name="dashboard_id" class="form-control ccxdashboard-width-select">
                        ...
                        <div class="ccxdashboard-actions-section-right">
                            <div class="ccxdashboard-period-select">
                                <?php
                                ...
                                $tmp_selected = false;
                                ?>
                                <select class="selectpicker ccxdashboard-period-dropdown" data-width="100%"
                                    ...
                                    <option value="<?= implode(';', $tmp_last_3_months) ?>" <?php if ($tmp_req_period === implode(';', $tmp_last_3_months)) {
                                           echo 'selected';
                                           $tmp_selected = true;
                                       } ?>  data-subtext="<?php echo _d($tmp_last_3_months[0]); ?> - <?php echo _d($tmp_last_3_months[1]); ?>">
                                    ...
                                    <option value="<?= implode(';', $tmp_last_6_months) ?>" <?php if ($tmp_req_period === implode(';', $tmp_last_6_months)) {
                                           echo 'selected';
                                           $tmp_selected = true;
                                       } ?> data-subtext="<?php echo _d($tmp_last_6_months[0]); ?> - <?php echo _d($tmp_last_6_months[1]); ?>">
                                    ...
                                    <option value="<?= implode(';', $tmp_last_12_months) ?>" <?php if ($tmp_req_period === implode(';', $tmp_last_12_months)) {
                                           echo 'selected';
                                           $tmp_selected = true;
                                       } ?> data-subtext="<?php echo _d($tmp_last_12_months[0]); ?> - <?php echo _d($tmp_last_12_months[1]); ?>">
                                ...
                                <div class="ccxdashboard-date-range">
                                    <div class="row">
                                        <div class="col-md-12">
