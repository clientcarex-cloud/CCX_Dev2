(function($) { 
          ...
          var calendar_settings = {
            ...
            eventSources: [
              function (info, successCallback, failureCallback) {
                ...
                return $.getJSON(
                  admin_url + "ccx_dashboard/widgets/api_get_calendar_data",
                  $.extend({}, params, {
                    start: info.startStr,
                    end: info.endStr,
                  })
            ...
            dateClick: function (info) {
              ...
              $("#ccx_dashboard_new_event_modal_" + widgetId).modal("show");
              return false;
            },
          };
    ...
    $(".widget-leads-chart").each(function () {
      ...
      if (leads_chart.length > 0) {
        new Chart(leads_chart, {
          type: "doughnut",
          data: window[
            "ccx_dashboard_widget_leads_chart_" +
              widgetId +
              "_leads_status_stats"
          ],
          options: {
    ...
    $(".widget-projects-chart").each(function () {
      ...
      if (projects_chart.length > 0) {
        new Chart(projects_chart, {
          type: "doughnut",
          data: window[
            "ccx_dashboard_widget_projects_chart_" +
              widgetId +
    ...
    $(".widget-tickets-chart").each(function () {
      ...
      if (tickets_chart_departments.length > 0) {
        var tickets_dep_chart = new Chart(tickets_chart_departments, {
          type: "doughnut",
          data: window[
            "ccx_dashboard_widget_tickets_chart_tickets_awaiting_reply_by_department_" +
              widgetId +
      ...
      if (tickets_chart_status.length > 0) {
        new Chart(tickets_chart_status, {
          type: "doughnut",
          data: window[
            "ccx_dashboard_widget_tickets_chart_tickets_reply_by_status_" +
              widgetId +
    ...
    $(".widget-todos").each(function () {
      ...
      $(".widget-" + widgetId + " .read-more").readmore({
        ...
        moreLink:
          '<a href="#">' +
          window[
            "ccx_dashboard_widget_todos_" + widgetId + "lang_read_more"
          ] +
          "</a>",
        lessLink:
          '<a href="#">' +
          window[
            "ccx_dashboard_widget_todos_" + widgetId + "lang_show_less"
          ] +
          "</a>",
      });
    });
  ...
  (function () {
    $(".widget-weekly-payments-chart").each(function () {
      ...
      init_weekly_payment_statistics(
        window[
          "ccx_dashboard_widget_weekly_payments_chart_" +
            widgetId +
  ...
  (function () {
    $(".widget-monthly-income").each(function () {
      ...
      new Chart($("#ccx_dashboard_widget_" + widgetId + "_chart_income"), {
        type: "bar",
        data: window[
          "ccx_dashboard_widget_monthly_income_" + widgetId + "_data"
        ],
        options: {
          responsive: true,
          maintainAspectRatio: false,
  ...
  (function () {
    $(".widget-total-staff-of-roles").each(function () {
      ...
      if (chart.length > 0) {
        new Chart(chart, {
          type: "doughnut",
          data: window["ccx_dashboard_widget_" + widgetId + "_chart_data"],
          options: {
            maintainAspectRatio: false,
            onClick: function (evt) {
              onChartClickRedirect(evt, this);
  ...
  (function () {
    $(".widget-staff-increment-by-years").each(function () {
      ...
      new Chart($("#ccx_dashboard_widget_" + widgetId + "_chart"), {
        type: "bar",
        data: window["ccx_dashboard_widget_" + widgetId + "_data"],
        options: {
          responsive: true,
          maintainAspectRatio: false,
          legend: {
  ...
  (function () {
    $(".widget-leads-and-converted-leads-by-sources").each(function () {
      ...
      new Chart($("#ccx_dashboard_widget_" + widgetId + "_chart_data"), {
        type: "bar",
        data: window["ccx_dashboard_widget_" + widgetId + "_chart_data"],
        options: {
          responsive: true,
