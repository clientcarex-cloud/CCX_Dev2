...
<div id="wrapper" class="customer_profile">
    <div class="content">
        ...
        <div class="md:tw-flex md:tw-gap-6">
            <?php if (isset($client)) { ?>
                <div class="md:tw-max-w-64 tw-w-full">
                    <?php $this->load->view('patients/patient_tabs'); ?>
                </div>
            <?php } ?>
            <div
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            <div class="tab-content">
                                <?php
                                $view_path = (isset($tab) ? $tab['view'] : 'patients/groups/profile');
                                if ($view_path == 'admin/clients/groups/profile') {
                                    $view_path = 'patients/groups/profile';
                                } elseif ($view_path == 'admin/clients/groups/tasks') {
                                    $view_path = 'patients/groups/tasks';
                                }
...
<?php } ?>
<?php $this->load->view('patients/patient_js'); ?>
</body>
