      ...
      <div class="row">
         <div class="col-md-6 col-md-offset-3">
            <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700">
               <?php echo _l('facelogin_setting') ?>
            </h4>
            <?php echo form_open($this->uri->uri_string()); ?>
            <div class="panel_s">
               <div class="panel-body">
               <?php render_yes_no_option('facelogin_is_active', 'facelogin_is_active'); ?>
               <hr>
                  <?php echo render_input('settings[facelogin_purchase_code]', 'purchase_code', get_option('facelogin_purchase_code'), 'text',['required'=>'required']); ?>
