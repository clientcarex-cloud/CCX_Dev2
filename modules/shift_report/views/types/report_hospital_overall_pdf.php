...
<table style="width: 100%; border: none;">
    <tr>
        <td style="border: none; width: 70%;">
            <h3 style="margin: 0;">HOSPITAL USER WISE CONSOLIDATED REPORT</h3>
        </td>
...
<table cellpadding="4">
    ...
    <tfoot>
        ...
        <tr>
            ...
            <th width="20%" rowspan="2" style="vertical-align: middle;"></th>
            <th width="8%"></th>
            <th width="8%"></th>
            <th width="11%" rowspan="2" style="vertical-align: middle;"></th>
            <th width="10%" rowspan="2" style="vertical-align: middle;"></th>
            <th width="11%" rowspan="2" style="vertical-align: middle;"></th>
