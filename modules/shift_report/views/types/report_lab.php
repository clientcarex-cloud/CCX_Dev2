                ...
                <div class="panel_s">
                    <div class="panel-body">
                                ...
                                <div style="display: flex; align-items: flex-end; gap: 15px;">
                                    ...
                                    <div class="form-group mbot0">
                                        ...
                                        <?php if ($staff_id && $date): ?>
                                            <a href="<?php echo admin_url('shift_report/pdf?staff_id=' . $staff_id . '&date=' . $date . '&type=' . $this->input->get('type')); ?>"
                        ...
                        <div id="shift-report-content">
                            <h3 class="text-center font-weight-bold">LAB Shift Report of
