                    ...
                    <div class="panel-body">
                        ...
                        <div class="horizontal-scrollable-tabs">
                            ...
                            <div class="horizontal-tabs">
                                <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
                                    ...
                                    <li role="presentation">
                                        <a href="#digital_case_taking" aria-controls="digital_case_taking" role="tab"
                                            data-toggle="tab">Digital Case Taking</a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#case_takings_table" aria-controls="case_takings_table" role="tab"
                                            data-toggle="tab">Case Takings Table</a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#case_taking_qas" aria-controls="case_taking_qas" role="tab"
                                            data-toggle="tab">Case Taking QAs</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="filters">
                                <?php echo form_open(admin_url('case_taking/settings')); ?>
                                <input type="hidden" name="settings_group" value="filters">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="case_taking_default_date_filter">Default Date Filter</label>
                                        <select name="case_taking_default_date_filter"
                                            id="case_taking_default_date_filter" class="form-control selectpicker">
                                            <option value="" <?php echo get_option('case_taking_default_date_filter') == '' ? 'selected' : ''; ?>>None</option>
                                            <option value="today" <?php echo get_option('case_taking_default_date_filter') == 'today' ? 'selected' : ''; ?>>Today</option>
                                            <option value="yesterday" <?php echo get_option('case_taking_default_date_filter') == 'yesterday' ? 'selected' : ''; ?>>Yesterday</option>
                                            <option value="yesterday_today" <?php echo get_option('case_taking_default_date_filter') == 'yesterday_today' ? 'selected' : ''; ?>>Yesterday & Today</option>
                                        </select>
                                    </div>
                                </div>
                                <hr />
                            ...
                            <div role="tabpanel" class="tab-pane" id="hide_show">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="text-info bold">Toggle visibility of filters on the Case Taking list
                                            page.</p>
                                    </div>
                                    <div class="col-md-12">
                                        <!-- Date Range Filter -->
                                        <div class="form-group">
                                            <label for="case_taking_show_date_filter">Show Date Filter</label>
                                            <div class="onoffswitch">
                                                <input type="checkbox" name="case_taking_show_date_filter"
                                                    class="onoffswitch-checkbox" id="case_taking_show_date_filter"
                                                    value="1" <?php echo get_option('case_taking_show_date_filter') == '1' || get_option('case_taking_show_date_filter') === '' ? 'checked' : ''; ?>>
                                                <label class="onoffswitch-label" for="case_taking_show_date_filter">
                            ...
                            <!-- Digital Case Taking Tab -->
                            <div role="tabpanel" class="tab-pane" id="digital_case_taking">
                                <?php echo form_open(admin_url('case_taking/settings')); ?>
                                <input type="hidden" name="settings_group" value="digital_case_taking">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="case_taking_mode_type" class="control-label">Case Taking Mode Type</label>
                                                    <select name="case_taking_mode_type" id="case_taking_mode_type" class="form-control selectpicker">
                                                        <option value="digital" <?php echo (get_option('case_taking_mode_type') == 'digital' || get_option('case_taking_mode_type') == '') ? 'selected' : ''; ?>>Digital</option>
                                                        <option value="manual" <?php echo get_option('case_taking_mode_type') == 'manual' ? 'selected' : ''; ?>>Manual</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="onoffswitch">
                                                        <input type="checkbox" name="case_taking_enable_autosave"
                                                            class="onoffswitch-checkbox" id="case_taking_enable_autosave"
                                                            value="1" <?php echo get_option('case_taking_enable_autosave') == '1' ? 'checked' : ''; ?>>
                                                        <label class="onoffswitch-label" for="case_taking_enable_autosave">
                                                            <span class="onoffswitch-inner"></span>
                                                            <span class="onoffswitch-switch"></span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="case_taking_edit_timeout" class="control-label">Disable Edit Button After (Completed Case Takings)</label>
                                                    <select name="case_taking_edit_timeout" id="case_taking_edit_timeout" class="form-control selectpicker">
                                                        <option value="5" <?php echo get_option('case_taking_edit_timeout') == '5' ? 'selected' : ''; ?>>5 Minutes</option>
                                                        <option value="10" <?php echo get_option('case_taking_edit_timeout') == '10' ? 'selected' : ''; ?>>10 Minutes</option>
                                                        <option value="15" <?php echo get_option('case_taking_edit_timeout') == '15' ? 'selected' : ''; ?>>15 Minutes</option>
                                                        <option value="30" <?php echo get_option('case_taking_edit_timeout') == '30' ? 'selected' : ''; ?>>30 Minutes</option>
                                                        <option value="60" <?php echo get_option('case_taking_edit_timeout') == '60' ? 'selected' : ''; ?>>1 Hour</option>
                                                        <option value="360" <?php echo get_option('case_taking_edit_timeout') == '360' ? 'selected' : ''; ?>>6 Hours</option>
                                                        <option value="720" <?php echo get_option('case_taking_edit_timeout') == '720' ? 'selected' : ''; ?>>12 Hours</option>
                                                        <option value="1440" <?php echo get_option('case_taking_edit_timeout') == '1440' ? 'selected' : ''; ?>>24 Hours</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($custom_fields as $field) {
                                                        ...
                                                        $template_key = 'case_taking_qa_template_' . $key;
                                                        // For system fields, we still use get_option for backward compatibility if needed, 
                                                        // OR we rely on the `case_taking_custom_fields` table data. 
                                                        ...
                                                        // Logic: Controller `settings` method saves `case_taking_qa_template_$slug` option for ALL fields.
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                    <a href="<?php echo admin_url('case_taking/master_data/'.$key); ?>" class="btn btn-default btn-xs" target="_blank">Master Data</a>
                                                            </td>
                                                            <td>
                                                                <div class="onoffswitch">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $other_fields = [
                                                        'case_taking_show_vitals' => 'Vitals',
                                                    ];
                            ...
                            <!-- Case Takings Table Tab -->
                            <div role="tabpanel" class="tab-pane" id="case_takings_table">
                                <?php echo form_open(admin_url('case_taking/settings')); ?>
                                <input type="hidden" name="settings_group" value="case_takings_table">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="text-info bold">Configure Case Takings Table Visibility</p>
                                    </div>
                                    <div class="col-md-12">
                                        <!-- Options Column Visibility -->
                                        <div class="form-group">
                                            <label for="case_taking_show_options_column">Show "Options" Column</label>
                                            <div class="onoffswitch">
                                                <input type="checkbox" name="case_taking_show_options_column"
                                                    class="onoffswitch-checkbox" id="case_taking_show_options_column"
                                                    value="1" <?php echo get_option('case_taking_show_options_column') == '1' || get_option('case_taking_show_options_column') === '' ? 'checked' : ''; ?>>
                                                <label class="onoffswitch-label" for="case_taking_show_options_column">
                                                    <span class="onoffswitch-inner"></span>
                                                    <span class="onoffswitch-switch"></span>
                                                </label>
                                            </div>
                            ...
                            <!-- Case Taking QAs Tab -->
                            <div role="tabpanel" class="tab-pane" id="case_taking_qas">
                                <div class="row">
                                    <div class="col-md-12">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if (isset($template['usage_count']) && $template['usage_count'] > 0) {
                                                                echo '<span class="label label-info">' . $template['usage_count'] . ' Case Takings</span>';
                                                            } else {
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo admin_url('case_taking/delete_qa_template/' . $template['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
...
<div class="modal fade" id="qa_template_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <?php echo form_open(admin_url('case_taking/settings')); ?>
        <input type="hidden" name="settings_group" value="case_taking_qas_save">
...
<script>
    ...
    $(function(){
        ...
        if(group == 'case_taking_qas'){
            $('a[href="#case_taking_qas"]').click();
        }
    });
    ...
    function delete_custom_field(id) {
        if(confirm('Are you sure you want to delete this field? Data associated with it will be lost.')) {
            $.post(admin_url + 'case_taking/delete_custom_field/' + id, function(response) {
    ...
    $(function(){
        $('#add_custom_field_form').on('submit', function(e) {
            ...
            $.post(admin_url + 'case_taking/save_custom_field', data, function(response) {
                var res = JSON.parse(response);
                if(res.success) {
...
<div class="modal fade" id="add_custom_field_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <?php echo form_open(admin_url('case_taking/save_custom_field'), array('id'=>'add_custom_field_form')); ?>
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
