                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php if (isset($role)) { ?>
                            ...
                            <?php } ?>
                        <?php } ?>
                        <?php $attrs = (isset($role) ? ['readonly' => true] : ['autofocus' => true]); ?>
                        <?php $value = (isset($role) ? $role->name : ''); ?>
                        <?php echo render_input('name', 'role_add_edit_name', $value, 'text', $attrs); ?>
                        <?php
                        // Load standard permissions view
                        $this->load->view('admin/staff/permissions', ['funcData' => ['role' => $role ?? null]]);
                        ?>
                        <hr />
                                ...
                                <table class="table dt-table">
                                    ...
                                    <tbody>
                                        <?php foreach ($role_staff as $staff) { ?>
                                            <tr>
                                                <td>
                                                    <?php echo '<a href="' . admin_url('staff/profile/' . $staff['staffid']) . '">' . staff_profile_image($staff['staffid'], [
