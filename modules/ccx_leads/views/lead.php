            ...
            <div class="col-md-6">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php
                        $data['lead'] = isset($lead) ? $lead : null;
                        $data['statuses'] = isset($statuses) ? $statuses : [];
                        $data['sources'] = isset($sources) ? $sources : [];
                        $data['staff_members'] = isset($staff_members) ? $staff_members : [];
                        $data['priorities'] = isset($priorities) ? $priorities : [];
                        $this->load->view('ccx_leads/lead_form_fields', $data);
                        ?>
