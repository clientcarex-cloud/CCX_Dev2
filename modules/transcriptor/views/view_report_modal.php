            ...
            <div class="modal-body" style="padding: 0;">
                <div class="row no-margin">
                    ...
                    <div class="col-md-9"
                        ...
                        <iframe src="<?php echo admin_url('transcriptor/preview/' . $report->id); ?>"
                    ...
                    <div class="col-md-3"
                        ...
                        <p class="bold font-medium no-mbot"><?php echo $report->patient_name; ?></p>
                        <p class="text-muted"><?php echo $report->age; ?> Years | <?php echo $report->gender; ?></p>
                        <p class="text-muted">Ref. Doctor: <span
                                class="text-dark bold"><?php echo $report->ref_doc_name; ?></span></p>
                        ...
                        <div class="mtop20">
                            ...
                            <p class="bold no-mbot"><?php echo $report->test_name; ?></p>
                            <p class="text-muted">Reported At: <span
                                    class="text-dark bold"><?php echo _dt($report->updated_at); ?></span></p>
                        </div>
                        ...
                        <div class="mtop30 ptop20"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <button onclick="print_tran_report('letterhead'); return false;"
                                        class="btn btn-success btn-block">With Letterhead</button>
                                </div>
                                <div class="col-md-6">
                                    <button onclick="print_tran_report('plain'); return false;"
                                        class="btn btn-success btn-block">Without Letterhead</button>
                                </div>
                            </div>
                        </div>
...
<script>
    function print_tran_report(mode) {
        var url = '<?php echo admin_url("transcriptor/preview/" . $report->id); ?>';
        if (mode == 'letterhead') {
            url += '?print=true&letterhead=true';
        } else {
            url += '?print=true&letterhead=false';
        }
