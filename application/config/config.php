...
$config['csrf_exclude_uris'] = ['admin/medicines', 'forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+', 'razorpay/success\/.+', 'web_integration/forms/submit/[0-9a-z]+', 'ccx_leads_api\/.+'];
